                ...
                <?php  echo $this->pagination->create_links(); ?>
                    <div class="row">
                        ...
                        foreach($list as  $row)
                        {
                            ...
                            <button type="button" name="add_cart1" class="btn btn-success add_cart1" id="add_cart1" data-productname1="'.$row->nom_plat.'" data-price1="'.$row->prix.'" data-productid1="'.$row->id_plat.'">Ajouter à la commande  </button>
                            </div>
                            ';
                        }
                        ?> 
