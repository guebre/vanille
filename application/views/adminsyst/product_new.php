...
<div class="container marge-top"> 
   <h4  class="text-center"> <u> AJOUT  DE PRODUIT </u>  </h4>
   <div class="row">
        <div class="col-4">
            <?php  
        ...
        <?php  endif; ?>
           <?php echo form_open("admin/new_product",array('id'=>'new_p')); ?>
            
            <div class="form-group">
                <label class="col-form-label" for="nom_p"><span class="font-weight-bold">Nom Produit </span></label>
                <input  name="nom_p" type="text" class="form-control" id="nom_cat" placeholder="THE" required>
            </div>
            <div class="form-group">
                <label class="col-form-label" for="p_unit"><span class="font-weight-bold">Prix Unitaire </span></label>
                <input  name="p_unit" type="number" class="form-control " id="p_unit" placeholder="100" required >
            </div>
            <div class="form-group">
                <label class="col-form-label" for="qte"><span class="font-weight-bold">Quantit&eacute </span></label>
                <input  name="qte" type="number" class="form-control" id="qte" placeholder="100" required >
            </div>
            <div class="form-group">
                <label class="col-form-label" for="qte_seuil"><span class="font-weight-bold">Niveau de Seuil </span></label>
                <input  name="qte_seuil" type="number" class="form-control" id="qte_seuil" placeholder="100" required>
            </div>
            <div class="form-group">
